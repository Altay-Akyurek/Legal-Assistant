    ...
    public function run(): void
    {
        ...
        $articles = [
            ...
            [
                ...
                'simplified_explanation'=>'Herkes,mülkiyet ve miras hakkına sahiptir.',
                'keywords'=>['mülkiyet','miras','mal','taşınmaz','sahiptik'],
                'right_category_slugs'=>['mulkiyet-hakki'],
            ],
            [
                'article_number'=>36,
                'title'=>'Çalışma ve Sözleşme Özgürlüğü',
                'official_text'=>'Herkes,dilediği alanda çalışma ve sözleşme hürriyetinine sahiptir.',
                'simplified_explanation'=>'Herkes isdediği alanda çalışma ve sözleşme özgürlüğüne sahiptir.',
                'keywords'=>['çalışma','iş','sözleşme','özgürlük','işci'],
                'right_category_slugs'=>['calisma-ve-sosyal-haklar'],
            ],
            [
                'article_number'=>42,
                'title'=>'Eğitim ve Öğrenim Hakkı',
                'official_text'=>'Kimse,eğitim ve öğretim hakkından yoksun bırakılamaz.',
